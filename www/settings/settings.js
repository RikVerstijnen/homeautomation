// Settings
$.domoticzurl = "http://192.168.1.196:8080";//domoticz url (can be with username:password@ip:port)
$.degreesUnit = " C";
$.percentUnit = " %";
...
//Weather settings
$.location = "Drunen, NB"; //city and region *required 
...
$.PageDashboardArray = [
    ...
    ['303', 'Temp', 'cell8', 'Temperatuur Woonkamer', 'woonkamer', '#2980B9'],
    ['303', 'LastUpdate', 'cell80', 'Temperatuur Woonkamer'],
