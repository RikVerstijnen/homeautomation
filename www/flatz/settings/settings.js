// Settings
$.domoticzurl = "http://user:Rickyboy22@192.168.1.196:8080";//domoticz url (can be with username:password@ip:port)
$.degreesUnit = " C";
$.percentUnit = " %";
...
//Weather settings
$.location = "Drunen, NBR"; //city and region *required 
...
$.PageDashboardArray = [
    //switches
    ['178', 'Data', 'cell1', 'Rik thuis', 'onbutton'],
    ['197', 'Data', 'cell2', 'Sabine thuis', 'onbutton'],
    ...
    ['29', 'Temp', 'cell8', 'Temperatuur Woonkamer', 'woonkamer', '#2980B9'],
    ['29', 'LastUpdate', 'cell80', 'Temperatuur Woonkamer'],
    ...
    ['209', 'Temp', 'cell10', 'Temperatuur Buiten', 'buiten', '#C0382B'],
    ['209', 'LastUpdate', 'cell100', 'Temperatuur Buiten'],
...
$.GraphTemperatureArray = [
    ...
    ['97', 'counter&method=1', 'day', 'cell7', 'Elektra', 'graph100', '#b2c831', 'v'],
    ['98', 'counter&method=1', 'day', 'cell8', 'Gas', 'graph100', '#b2c831', 'v'],
    ['29', 'temp', 'day', 'cell10', 'Temperatuur Woonkamer', 'graph300', '#2980B9', 'te'],
];
