...
function RefreshData()
{
	...
	if (typeof vdata == 'undefined') {
		...
		//vdata=new String(vdata).split("m3",1)[0]; Rik: Weg gehaald
   ...
   if(vtype == 'Level' && item.SwitchType == 'Dimmer') {
	...
	//Add m3 to gas
	if(item.idx == idx_Gas){
		vdata=new String(vdata).replace( " m3","<sup style=\'font-size:40%;vertical-align:top;position:relative;bottom:-0.6em;\'> m3</sup>");
	}
