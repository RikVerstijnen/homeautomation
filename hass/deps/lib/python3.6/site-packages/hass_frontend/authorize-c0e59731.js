...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/const PaperInputAddonBehavior={attached:function(){this.fire("addon-attached")},update:function(){}}},function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return noChange});const noChange={}},function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathmax=Math.max,_Mathmin=Math.min,_Mathabs2=Math.abs,polymer_legacy=__webpack_require__(2),polymer_dom=__webpack_require__(1);/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
http://polymer.github.io/LICENSE.txt The complete set of authors may be found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const isPrimitive=value=>null===value||!("object"===typeof value||"function"===typeof value);class AttributeCommitter{constructor(element,name,strings){this.dirty=!0;this.element=element;this.name=name;this.strings=strings;this.parts=[];for(let i=0;i<strings.length-1;i++){this.parts[i]=this._createPart()}}_createPart(){return new AttributePart(this)}_getValue(){const strings=this.strings,l=strings.length-1;let text="";for(let i=0;i<l;i++){text+=strings[i];const part=this.parts[i];if(part!==void 0){const v=part.value;if(null!=v&&(Array.isArray(v)||"string"!==typeof v&&v[Symbol.iterator])){for(const t of v){text+="string"===typeof t?t:t+""}}else{text+="string"===typeof v?v:v+""}}}text+=strings[l];return text}commit(){if(this.dirty){this.dirty=!1;this.element.setAttribute(this.name,this._getValue())}}}class AttributePart{constructor(comitter){this.value=void 0;this.committer=comitter}setValue(value){if(value!==_part_js__WEBPACK_IMPORTED_MODULE_2__.a&&(!isPrimitive(value)||value!==this.value)){this.value=value;if(!Object(_directive_js__WEBPACK_IMPORTED_MODULE_0__.b)(value)){this.committer.dirty=!0}}}commit(){while(Object(_directive_js__WEBPACK_IMPORTED_MODULE_0__.b)(this.value)){const directive=this.value;this.value=_part_js__WEBPACK_IMPORTED_MODULE_2__.a;directive(this)}if(this.value===_part_js__WEBPACK_IMPORTED_MODULE_2__.a){return}this.committer.commit()}}class NodePart{constructor(options){this.value=void 0;this._pendingValue=void 0;this.options=options}appendInto(container){this.startNode=container.appendChild(Object(_template_js__WEBPACK_IMPORTED_MODULE_5__.b)());this.endNode=container.appendChild(Object(_template_js__WEBPACK_IMPORTED_MODULE_5__.b)())}insertAfterNode(ref){this.startNode=ref;this.endNode=ref.nextSibling}appendIntoPart(part){part._insert(this.startNode=Object(_template_js__WEBPACK_IMPORTED_MODULE_5__.b)());part._insert(this.endNode=Object(_template_js__WEBPACK_IMPORTED_MODULE_5__.b)())}insertAfterPart(ref){ref._insert(this.startNode=Object(_template_js__WEBPACK_IMPORTED_MODULE_5__.b)());this.endNode=ref.endNode;ref.endNode=this.startNode}setValue(value){this._pendingValue=value}commit(){while(Object(_directive_js__WEBPACK_IMPORTED_MODULE_0__.b)(this._pendingValue)){const directive=this._pendingValue;this._pendingValue=_part_js__WEBPACK_IMPORTED_MODULE_2__.a;directive(this)}const value=this._pendingValue;if(value===_part_js__WEBPACK_IMPORTED_MODULE_2__.a){return}if(isPrimitive(value)){if(value!==this.value){this._commitText(value)}}else if(value instanceof _template_result_js__WEBPACK_IMPORTED_MODULE_4__.b){this._commitTemplateResult(value)}else if(value instanceof Node){this._commitNode(value)}else if(Array.isArray(value)||value[Symbol.iterator]){this._commitIterable(value)}else if(value.then!==void 0){this._commitPromise(value)}else{this._commitText(value)}}_insert(node){this.endNode.parentNode.insertBefore(node,this.endNode)}_commitNode(value){if(this.value===value){return}this.clear();this._insert(value);this.value=value}_commitText(value){const node=this.startNode.nextSibling;value=null==value?"":value;if(node===this.endNode.previousSibling&&node.nodeType===Node.TEXT_NODE){node.textContent=value}else{this._commitNode(document.createTextNode("string"===typeof value?value:value+""))}this.value=value}_commitTemplateResult(value){const template=this.options.templateFactory(value);if(this.value&&this.value.template===template){this.value.update(value.values)}else{const instance=new _template_instance_js__WEBPACK_IMPORTED_MODULE_3__.a(template,value.processor,this.options),fragment=instance._clone();instance.update(value.values);this._commitNode(fragment);this.value=instance}}_commitIterable(value){if(!Array.isArray(this.value)){this.value=[];this.clear()}const itemParts=this.value;let partIndex=0,itemPart;for(const item of value){itemPart=itemParts[partIndex];if(itemPart===void 0){itemPart=new NodePart(this.options);itemParts.push(itemPart);if(0===partIndex){itemPart.appendIntoPart(this)}else{itemPart.insertAfterPart(itemParts[partIndex-1])}}itemPart.setValue(item);itemPart.commit();partIndex++}if(partIndex<itemParts.length){itemParts.length=partIndex;this.clear(itemPart&&itemPart.endNode)}}_commitPromise(value){this.value=value;value.then(v=>{if(this.value===value){this.setValue(v);this.commit()}})}clear(startNode=this.startNode){Object(_dom_js__WEBPACK_IMPORTED_MODULE_1__.b)(this.startNode.parentNode,startNode.nextSibling,this.endNode)}}class BooleanAttributePart{constructor(element,name,strings){this.value=void 0;this._pendingValue=void 0;if(2!==strings.length||""!==strings[0]||""!==strings[1]){throw new Error("Boolean attributes can only contain a single expression")}this.element=element;this.name=name;this.strings=strings}setValue(value){this._pendingValue=value}commit(){while(Object(_directive_js__WEBPACK_IMPORTED_MODULE_0__.b)(this._pendingValue)){const directive=this._pendingValue;this._pendingValue=_part_js__WEBPACK_IMPORTED_MODULE_2__.a;directive(this)}if(this._pendingValue===_part_js__WEBPACK_IMPORTED_MODULE_2__.a){return}const value=!!this._pendingValue;if(this.value!==value){if(value){this.element.setAttribute(this.name,"")}else{this.element.removeAttribute(this.name)}}this.value=value;this._pendingValue=_part_js__WEBPACK_IMPORTED_MODULE_2__.a}}class PropertyCommitter extends AttributeCommitter{constructor(element,name,strings){super(element,name,strings);this.single=2===strings.length&&""===strings[0]&&""===strings[1]}_createPart(){return new PropertyPart(this)}_getValue(){if(this.single){return this.parts[0].value}return super._getValue()}commit(){if(this.dirty){this.dirty=!1;this.element[this.name]=this._getValue()}}}class PropertyPart extends AttributePart{}let eventOptionsSupported=!1;try{const options={get capture(){eventOptionsSupported=!0;return!1}};window.addEventListener("test",options,options);window.removeEventListener("test",options,options)}catch(_e){}class EventPart{constructor(element,eventName,eventContext){this.value=void 0;this._pendingValue=void 0;this.element=element;this.eventName=eventName;this.eventContext=eventContext}setValue(value){this._pendingValue=value}commit(){while(Object(_directive_js__WEBPACK_IMPORTED_MODULE_0__.b)(this._pendingValue)){const directive=this._pendingValue;this._pendingValue=_part_js__WEBPACK_IMPORTED_MODULE_2__.a;directive(this)}if(this._pendingValue===_part_js__WEBPACK_IMPORTED_MODULE_2__.a){return}const newListener=this._pendingValue,oldListener=this.value,shouldRemoveListener=null==newListener||null!=oldListener&&(newListener.capture!==oldListener.capture||newListener.once!==oldListener.once||newListener.passive!==oldListener.passive);if(shouldRemoveListener){this.element.removeEventListener(this.eventName,this,this._options)}this._options=getOptions(newListener);if(null!=newListener&&(null==oldListener||shouldRemoveListener)){this.element.addEventListener(this.eventName,this,this._options)}this.value=newListener;this._pendingValue=_part_js__WEBPACK_IMPORTED_MODULE_2__.a}handleEvent(event){const listener="function"===typeof this.value?this.value:"function"===typeof this.value.handleEvent?this.value.handleEvent:()=>null;listener.call(this.eventContext||this.element,event)}}const getOptions=o=>o&&(eventOptionsSupported?{capture:o.capture,passive:o.passive,once:o.once}:o.capture)},function(module,__webpack_exports__,__webpack_require__){"use strict";var parts=__webpack_require__(66);/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class TemplateResult{constructor(strings,values,type,processor){this.strings=strings;this.values=values;this.type=type;this.processor=processor}getHTML(){const l=this.strings.length-1;let html="",isTextBinding=!0;for(let i=0;i<l;i++){const s=this.strings[i];html+=s;const close=s.lastIndexOf(">");isTextBinding=(-1<close||isTextBinding)&&-1===s.indexOf("<",close+1);if(!isTextBinding&&_template_js__WEBPACK_IMPORTED_MODULE_1__.g){html=html.replace(_template_js__WEBPACK_IMPORTED_MODULE_1__.d,(match,p1,p2,p3)=>{return"style"===p2?`${p1}style$${p3}`:match})}html+=isTextBinding?_template_js__WEBPACK_IMPORTED_MODULE_1__.f:_template_js__WEBPACK_IMPORTED_MODULE_1__.e}html+=this.strings[l];return html}getTemplateElement(){const template=document.createElement("template");template.innerHTML=this.getHTML();return template}}class SVGTemplateResult extends TemplateResult{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const template=super.getTemplateElement(),content=template.content,svgElement=content.firstChild;content.removeChild(svgElement);Object(_dom_js__WEBPACK_IMPORTED_MODULE_0__.c)(content,svgElement.firstChild);return template}}},function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.d(__webpack_exports__,"a",function(){return IronRangeBehavior});__webpack_require__(2);/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
http://polymer.github.io/LICENSE.txt The complete set of authors may be found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function templateFactory(result){let templateCache=templateCaches.get(result.type);if(templateCache===void 0){templateCache=new Map;templateCaches.set(result.type,templateCache)}let template=templateCache.get(result.strings);if(template===void 0){template=new _template_js__WEBPACK_IMPORTED_MODULE_0__.a(result,result.getTemplateElement());templateCache.set(result.strings,template)}return template}const templateCaches=new Map},function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_polymer_polymer_legacy_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(2),_polymer_iron_meta_iron_meta_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(44),_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(3),_polymer_polymer_lib_legacy_polymer_dom_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(1);/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
http://polymer.github.io/LICENSE.txt The complete set of authors may be found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const parts=new WeakMap,render=(result,container,options)=>{let part=parts.get(container);if(part===void 0){Object(_dom_js__WEBPACK_IMPORTED_MODULE_0__.b)(container,container.firstChild);parts.set(container,part=new _parts_js__WEBPACK_IMPORTED_MODULE_1__.e(Object.assign({templateFactory:_template_factory_js__WEBPACK_IMPORTED_MODULE_2__.b},options)));part.appendInto(container)}part.setValue(result);part.commit()}},,,,,,,function(module,__webpack_exports__,__webpack_require__){"use strict";var custom_style_interface=__webpack_require__(60),common_utils=__webpack_require__(25),style_settings=__webpack_require__(16);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
<div id="checkboxLabel"><slot></slot></div>`;template.setAttribute("strip-whitespace","");Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:template,is:"paper-checkbox",behaviors:[_polymer_paper_behaviors_paper_checked_element_behavior_js__WEBPACK_IMPORTED_MODULE_2__.a],hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{ariaActiveAttribute:{type:String,value:"aria-checked"}},attached:function(){Object(_polymer_polymer_lib_utils_render_status_js__WEBPACK_IMPORTED_MODULE_6__.a)(this,function(){var inkSize=this.getComputedStyleValue("--calculated-paper-checkbox-ink-size").trim();if("-1px"===inkSize){var checkboxSizeText=this.getComputedStyleValue("--calculated-paper-checkbox-size").trim(),units="px",unitsMatches=checkboxSizeText.match(/[A-Za-z]+$/);if(null!==unitsMatches){units=unitsMatches[0]}var checkboxSize=parseFloat(checkboxSizeText),defaultInkSize=8/3*checkboxSize;if("px"===units){defaultInkSize=Math.floor(defaultInkSize);if(defaultInkSize%2!==checkboxSize%2){defaultInkSize++}}this.updateStyles({"--paper-checkbox-ink-size":defaultInkSize+units})}})},_computeCheckboxClass:function(checked,invalid){var className="";if(checked){className+="checked "}if(invalid){className+="invalid"}return className},_computeCheckmarkClass:function(checked){return checked?"":"hidden"},_createRipple:function(){this._rippleContainer=this.$.checkboxContainer;return _polymer_paper_behaviors_paper_inky_focus_behavior_js__WEBPACK_IMPORTED_MODULE_3__.b._createRipple.call(this)}})},,function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__(141);const PaperSliderClass=customElements.get("paper-slider");class HaPaperSlider extends PaperSliderClass{static get template(){const tpl=document.createElement("template");tpl.innerHTML=PaperSliderClass.template.innerHTML;const styleEl=document.createElement("style");styleEl.innerHTML=`
    ...
    `;tpl.content.appendChild(styleEl);return tpl}}customElements.define("ha-paper-slider",HaPaperSlider)},,,,function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_paper_checkbox_paper_checkbox__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(157),_polymer_paper_dropdown_menu_paper_dropdown_menu__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(135),_polymer_paper_icon_button_paper_icon_button__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(64),_polymer_paper_input_paper_input__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(65),_polymer_paper_item_paper_item__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(131),_polymer_paper_listbox_paper_listbox__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(133),_polymer_polymer_lib_utils_html_tag__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__(0),_polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_7__=__webpack_require__(4),_ha_paper_slider__WEBPACK_IMPORTED_MODULE_8__=__webpack_require__(159),_mixins_events_mixin__WEBPACK_IMPORTED_MODULE_9__=__webpack_require__(19);class HaForm extends Object(_mixins_events_mixin__WEBPACK_IMPORTED_MODULE_9__.a)(_polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_7__.a){static get template(){return _polymer_polymer_lib_utils_html_tag__WEBPACK_IMPORTED_MODULE_6__.a`
      <style>
        .error {
          color: red;
        }
    ...
    `}static get properties(){return{data:{type:Object,notify:!0},schema:Object,error:Object,computeLabel:{type:Function,value:()=>schema=>schema&&schema.name},computeError:{type:Function,value:()=>error=>error}}}_isArray(val){return Array.isArray(val)}_isRange(schema){return"valueMin"in schema&&"valueMax"in schema}_equals(a,b){return a===b}_includes(a,b){return 0<=a.indexOf(b)}_getValue(obj,item){if(obj){return obj[item.name]}return null}_valueChanged(ev){let value=ev.detail.value;if("integer"===ev.model.item.type){value=+ev.detail.value}this.set(["data",ev.model.item.name],value)}_passwordFieldType(unmaskedPassword){return unmaskedPassword?"text":"password"}_passwordFieldIcon(unmaskedPassword){return unmaskedPassword?"hass:eye-off":"hass:eye"}_optionValue(item){return Array.isArray(item)?item[0]:item}_optionLabel(item){return Array.isArray(item)?item[1]:item}}customElements.define("ha-form",HaForm)},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var dom_if=__webpack_require__(84),dom_repeat=__webpack_require__(83),ha_iconset_svg=__webpack_require__(111),ha_style=__webpack_require__(132),roboto=__webpack_require__(110),hass_translation=__webpack_require__(45),localize_lite_base_mixin=__webpack_require__(89);const empty=()=>"",litLocalizeLiteMixin=(superClass)=>class extends Object(localize_lite_base_mixin.a)(superClass){static get properties(){return{hass:{},localize:{},language:{},resources:{},translationFragment:{}}}constructor(){super();this.localize=empty;this.language=Object(hass_translation.a)()}connectedCallback(){super.connectedCallback();this._initializeLocalizeLite();this.localize=this.__computeLocalize(this.language,this.resources)}updated(changedProperties){super.updated(changedProperties);if(changedProperties.has("language")||changedProperties.has("resources")){this.localize=this.__computeLocalize(this.language,this.resources)}}};var lit_element=__webpack_require__(90),polymer_element=__webpack_require__(4),paper_button=__webpack_require__(57),html_tag=__webpack_require__(0),ha_form=__webpack_require__(163),localize_lite_mixin=__webpack_require__(114);class ha_auth_flow_HaAuthFlow extends Object(localize_lite_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
      <style>
        :host {
    ...
    `}static get properties(){return{authProvider:{type:Object,observer:"_providerChanged"},clientId:String,redirectUri:String,oauth2State:String,_state:{type:String,value:"loading"},_stepData:{type:Object,value:()=>({})},_step:{type:Object,notify:!0},_errorMsg:String}}ready(){super.ready();this.addEventListener("keypress",ev=>{if(13===ev.keyCode){this._handleSubmit()}})}async _providerChanged(newProvider,oldProvider){if(oldProvider&&this._step&&"form"===this._step.type){fetch(`/auth/login_flow/${this._step.flow_id}`,{method:"DELETE",credentials:"same-origin"}).catch(()=>{})}try{const response=await fetch("/auth/login_flow",{method:"POST",credentials:"same-origin",body:JSON.stringify({client_id:this.clientId,handler:[newProvider.type,newProvider.id],redirect_uri:this.redirectUri})}),data=await response.json();if(response.ok){this._updateStep(data)}else{this.setProperties({_state:"error",_errorMsg:data.message})}}catch(err){console.error("Error starting auth flow",err);this.setProperties({_state:"error",_errorMsg:this.localize("ui.panel.page-authorize.form.unknown_error")})}}_updateStep(step){const props={_step:step,_state:"step"};if(this._step&&(step.flow_id!==this._step.flow_id||step.step_id!==this._step.step_id)){props._stepData={}}this.setProperties(props)}_equals(a,b){return a===b}_computeSubmitCaption(stepType){return"form"===stepType?"Next":"Start over"}_computeStepAbortedReason(localize,step){return localize(`ui.panel.page-authorize.form.providers.${step.handler[0]}.abort.${step.reason}`)}_computeStepDescription(localize,step){const args=[`ui.panel.page-authorize.form.providers.${step.handler[0]}.step.${step.step_id}.description`],placeholders=step.description_placeholders||{};Object.keys(placeholders).forEach(key=>{args.push(key);args.push(placeholders[key])});return localize(...args)}_computeLabelCallback(localize,step){return schema=>localize(`ui.panel.page-authorize.form.providers.${step.handler[0]}.step.${step.step_id}.data.${schema.name}`)}_computeErrorCallback(localize,step){return error=>localize(`ui.panel.page-authorize.form.providers.${step.handler[0]}.error.${error}`)}async _handleSubmit(){if("form"!==this._step.type){this._providerChanged(this.authProvider,null);return}this._state="loading";this.style.setProperty("min-height",`${this.offsetHeight}px`);const postData=Object.assign({},this._stepData,{client_id:this.clientId});try{const response=await fetch(`/auth/login_flow/${this._step.flow_id}`,{method:"POST",credentials:"same-origin",body:JSON.stringify(postData)}),newStep=await response.json();if("create_entry"===newStep.type){let url=this.redirectUri;if(!url.includes("?")){url+="?"}else if(!url.endsWith("&")){url+="&"}url+=`code=${encodeURIComponent(newStep.result)}`;if(this.oauth2State){url+=`&state=${encodeURIComponent(this.oauth2State)}`}document.location=url;return}this._updateStep(newStep)}catch(err){console.error("Error submitting step",err);this._state="error-loading"}finally{this.style.setProperty("min-height","")}}}customElements.define("ha-auth-flow",ha_auth_flow_HaAuthFlow);__webpack_require__.e(45).then(__webpack_require__.bind(null,715));class ha_authorize_HaAuthorize extends litLocalizeLiteMixin(lit_element.a){constructor(){super();this.translationFragment="page-authorize";const query={},values=location.search.substr(1).split("&");for(const item of values){const value=item.split("=");if(1<value.length){query[decodeURIComponent(value[0])]=decodeURIComponent(value[1])}}if(query.client_id){this.clientId=query.client_id}if(query.redirect_uri){this.redirectUri=query.redirect_uri}if(query.state){this.oauth2State=query.state}}static get properties(){return{_authProvider:{},_authProviders:{},clientId:{},redirectUri:{},oauth2State:{}}}render(){if(!this._authProviders){return lit_element.c`
      ...
      ${0<inactiveProviders.length?lit_element.c`
              ...
              ></ha-pick-auth-provider>
            `:""}
    `}async firstUpdated(){try{const response=await window.providersPromise,authProviders=await response.json();if(400===response.status&&"onboarding_required"===authProviders.code){location.href="/?";return}if(0===authProviders.length){alert("No auth providers returned. Unable to finish login.");return}this._authProviders=authProviders;this._authProvider=authProviders[0]}catch(err){console.error("Error loading auth providers",err)}}renderStyle(){return lit_element.c`
      <style>
        ha-pick-auth-provider {
          display: block;
          margin-top: 48px;
    ...
    `}async _handleAuthProviderPick(ev){this._authProvider=ev.detail}}customElements.define("ha-authorize",ha_authorize_HaAuthorize);setTimeout(()=>__webpack_require__.e(75).then(__webpack_require__.t.bind(null,695,7)),2e3)}]);
//# sourceMappingURL=authorize-c0e59731.js.map